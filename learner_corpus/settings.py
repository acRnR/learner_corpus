...
ROOT_URLCONF = 'learner_corpus.urls'

WSGI_APPLICATION = 'learner_corpus.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'learner_corpus',                      # Or path to database file if using sqlite3.
...
STATIC_URL = '/learner_corpus/static/'
