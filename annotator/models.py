...
class Document(models.Model):
    ...
    title = models.CharField(max_length=64, db_index=True, null=True, blank=True, editable=False)
    ...
    date1 = models.IntegerField(null=True, blank=True, help_text=_("When the work on the text started, e.g. 2014."), verbose_name=_('date1'))
    date2 = models.IntegerField(null=True, blank=True, help_text=_("When the text was finished, e.g. 2015."), verbose_name=_('date2'))
    genre = models.CharField(max_length=50, null=True, blank=True, db_index=True,  verbose_name=_('genre'))
    ...
    major = models.CharField(max_length=50, null=True, blank=True, db_index=True,  verbose_name=_('major'))
    course = models.CharField(max_length=50, null=True, blank=True, db_index=True, verbose_name=_('course'))
    term = models.IntegerField(null=True, blank=True, choices=((1, 1), (2, 2)), verbose_name=_('term'))
    module = models.IntegerField(null=True, blank=True, choices=((1, 1), (2, 2),
                                                                 (3, 3), (4, 4)), verbose_name=_('module'))
    domain = models.CharField(max_length=50, null=True, blank=True, verbose_name=_('domain'))
    level = models.CharField(max_length=50, null=True, blank=True, verbose_name=_('level'))
    time_limit = models.CharField(max_length=50, null=True, blank=True, verbose_name=_('time limit'))
    university = models.CharField(max_length=50, null=True, blank=True, verbose_name=_('university'))
    university_code = models.IntegerField(null=True, blank=True, verbose_name=_('university code'))
    student_code = models.IntegerField(null=True, blank=True, db_index=True, verbose_name=_('student code'))
